...
import sys
sys.path.insert(0,'/mnt/shared/home/b31xs3/PILOT')
...
def evaluate():
    ...
    args.predictions_path = f'/mnt/shared/home/b31xs3/PILOT/summary/{args.test_name}/rec'
...
def create_arg_parser():
    ...
    parser.add_argument('--target-path', type=pathlib.Path, default=f'/mnt/shared/home/b31xs3/',
    ...
    parser.add_argument('--data-path', type=pathlib.Path,
                        default='/mnt/shared/home/b31xs3/', help='Path to the dataset')
    return parser
